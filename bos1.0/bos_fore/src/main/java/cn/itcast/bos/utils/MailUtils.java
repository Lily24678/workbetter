...
public class MailUtils {
	...
	private static String username = "lishanyun_lsy@163.com"; // 邮箱账户
	private static String password = "itcast123"; // 邮箱授权码

	private static String from = "lishanyun_lsy@163.com"; // 使用当前账户
	...
	/*public static void main(String[] args) {
		sendMail("测试邮件", "你好，传智播客", "lishanyun_lsy@163.com");
	}*/
}
